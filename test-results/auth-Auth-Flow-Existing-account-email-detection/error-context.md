...
- Name: Auth Flow >> Existing account email detection
- Location: C:\Users\Farid wolasyar\Documents\Valauations\tests\auth.spec.ts:44:3
...
Call log:
  - waiting for getByRole('tab', { name: /sign up/i })

    at C:\Users\Farid wolasyar\Documents\Valauations\tests\auth.spec.ts:46:55
```
