...
- Name: Auth Flow >> Forgot password flow
- Location: C:\Users\Farid wolasyar\Documents\Valauations\tests\auth.spec.ts:36:3
...
Call log:
  - waiting for getByRole('link', { name: /forgot password/i })
    ...
    at C:\Users\Farid wolasyar\Documents\Valauations\tests\auth.spec.ts:38:64
```
