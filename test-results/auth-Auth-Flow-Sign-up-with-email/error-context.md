...
- Name: Auth Flow >> Sign up with email
- Location: C:\Users\Farid wolasyar\Documents\Valauations\tests\auth.spec.ts:9:3
...
Call log:
  - waiting for getByRole('tab', { name: /sign up/i })
    ...
    at C:\Users\Farid wolasyar\Documents\Valauations\tests\auth.spec.ts:11:55
```
