...
- Name: Auth Flow >> Sign up with phone
- Location: C:\Users\Farid wolasyar\Documents\Valauations\tests\auth.spec.ts:18:3
...
Call log:
  - waiting for getByRole('tab', { name: /sign up/i })
    ...
    at C:\Users\Farid wolasyar\Documents\Valauations\tests\auth.spec.ts:20:55
```
