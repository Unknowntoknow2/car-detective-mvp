...
<<<<<<< HEAD
  it('formats decimal values correctly', () => {
    expect(formatCurrency(1000.50, 'en-US', 'USD', { maximumFractionDigits: 2 })).toBe('$1,000.50');
    expect(formatCurrency(1500.75, 'en-US', 'USD', { maximumFractionDigits: 2 })).toBe('$1,500.75');
=======
  it("formats decimal values correctly", () => {
...
<<<<<<< HEAD
  it('handles negative values correctly', () => {
    expect(formatCurrency(-1000)).toBe('-$1,000');
    expect(formatCurrency(-1500.50, 'en-US', 'USD', { maximumFractionDigits: 2 })).toBe('-$1,500.50');
=======
  it("handles negative values correctly", () => {
    expect(formatCurrency(-1000)).toBe("-$1,000");
...
<<<<<<< HEAD
    expect(formatCurrency(1000.50, 'de-DE', 'EUR', { maximumFractionDigits: 2 })).toBe('1.000,50 €');
