...
describe('VinInput Component', () => {
  ...
  it('displays validation error when provided', () => {
    render(<VinInput {...defaultProps} validationError="Invalid VIN" touched={true} />);
  ...
  it('does not display validation error when not touched', () => {
    render(<VinInput {...defaultProps} validationError="Invalid VIN" touched={false} />);
  ...
  it('shows success state when input is valid', () => {
    render(<VinInput {...defaultProps} isValid={true} touched={true} />);
  ...
  it('shows loading state when isLoading is true', () => {
    render(<VinInput {...defaultProps} isLoading={true} />);
