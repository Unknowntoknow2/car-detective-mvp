    ...
    const fetchStats = async () => {
      ...
      try {
        ...
        if (statsData && statsData.length > 0) {
          const totalVals = statsData.reduce(
            (sum, stat) => sum + stat.total_valuations,
            0,
          );
          const totalValue = statsData.reduce(
            (sum, stat) => sum + (stat.average_price * stat.total_valuations),
            0,
          );
  ...
  const handleShareClick = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text:
          "Check out these real-time car value trends and pricing insights!",
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Helmet>
        ...
        <meta
          name="description"
          content="See real-time car value trends, most valued models, and top ZIP codes for automotive valuations."
        />
        <meta
          property="og:title"
          content="Live Car Pricing Trends – Car Detective"
        />
        <meta
          property="og:description"
          content="Access real-time car value trends, most valued models, pricing data, and top markets."
        />
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4">
                      <div className="flex-1">
                        <h3 className="text-lg font-medium">
                          Get Your Own Car Valuation
                        </h3>
                        <p className="text-muted-foreground mt-1">
                          Find out exactly what your car is worth with our
                          precise valuation tool.
                        </p>
                      </div>
                        ...
                        {valuationStats
                          ...
                          .reduce((acc, stat) => {
                            ...
                            const existing = acc.find((s) =>
                              s.zip_code === stat.zip_code
                            );
                            if (existing) {
                              existing.total_valuations +=
                                stat.total_valuations;
                              existing.total_price += stat.average_price *
                                stat.total_valuations;
                            } else {
                              acc.push({
                                ...stat,
                                total_price: stat.average_price *
                                  stat.total_valuations,
                              });
                            }
                            return acc;
                          ...
                          .map((stat) => ({
                            ...stat,
                            average_price: stat.total_price /
                              stat.total_valuations,
                          }))
                    ...
                    : (
                      <div className="text-center py-10">
                        ...
                        <p className="text-muted-foreground mt-2">
                          Be the first to invite friends and appear on our
                          leaderboard
                        </p>
                      </div>
                    )}
              ...
              <CardContent className="pt-6">
                <div className="flex flex-col md:flex-row items-center gap-6">
                  <div className="flex-1">
                    ...
                    <p className="mt-2">
                      Get detailed market analysis, forecasting, and dealer
                      pricing not available in the free version.
                    </p>
