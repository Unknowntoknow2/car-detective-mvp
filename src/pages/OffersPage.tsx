    ...
    const mockOffers = [
      {
        ...
        dealer_id: "dealer1",
        message:
          "Great vehicle! We are interested in making a competitive offer.",
      ...
      },
      {
        ...
        dealer_id: "dealer2",
        message:
          "We have a customer looking for exactly this model. Can offer above market.",
  ...
  const getOfferBadge = (offer: any) => {
    ...
    switch (offer.label) {
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Badge
                  variant="outline"
                  className="bg-amber-100 text-amber-800 hover:bg-amber-200 border-amber-200 flex items-center gap-1"
                >
                  {offer.label}
      ...
      default:
        return (
          <Badge
            variant={offer.offer_amount > (valuationData?.estimatedValue || 0)
              ? "secondary"
              : "default"}
            className={offer.offer_amount > (valuationData?.estimatedValue || 0)
              ? "bg-green-100 text-green-800 hover:bg-green-100"
              : ""}
          >
            {offer.offer_amount > (valuationData?.estimatedValue || 0)
              ? "Above Market"
              : "Market Offer"}
          </Badge>
        );
      ...
      <div className="container mx-auto py-12">
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription className="space-y-4">
            <p>
              Please complete a vehicle valuation first to view dealer offers.
            </p>
            <div className="mt-4">
              <Link to="/">
        ...
        ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your vehicle information has been shared with our dealer
                network. Offers will appear here as dealers respond.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground text-sm">
                Typically, you can expect to receive offers within 24-48 hours.
                Make sure to check back later!
              </p>
            </CardContent>
            <CardFooter className="flex flex-col items-start gap-4">
              <p className="text-sm">
                Want to speed up the process? Upgrade to Premium for priority
                dealer matching.
              </p>
              <Link to="/upgrade">
        ...
        : (
          <div className="space-y-6">
              ...
              >
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle>
                        {offer.dealer_name || "Dealer Offer"}
                      </CardTitle>
                      <CardDescription>
                  ...
                  <div>
                    ...
                    {valuationData?.estimatedValue && (
                      <p className="text-sm text-muted-foreground">
                        {((offer.offer_amount / valuationData.estimatedValue) *
                            100 - 100).toFixed(1)}%
                        {offer.offer_amount > valuationData.estimatedValue
                          ? " above"
            ...
            <div className="mt-8 p-6 bg-slate-50 rounded-lg border">
              ...
              <p className="mb-4">
                These offers are provided by Car Detective partner dealers based
                on your vehicle information. Offers are valid for 7 days from
                when they are made.
              </p>
              <p className="text-sm text-muted-foreground">
                Accepting an offer is non-binding. The dealer will contact you
                to arrange inspection and complete the purchase.
              </p>
            </div>
          </div>
        )}
