...
import {
  ...
  mockInvoices,
  mockPaymentMethods,
} from "@/components/dealer/subscription/subscriptionData";
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Manage your dealer subscription and billing information
              </p>
            </div>
            ...
            <Card className="border-2 border-primary/10 shadow-md">
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start">
                  ...
                  <Badge
                    variant={currentPlan.status === "active"
                      ? "default"
                      : "secondary"}
                    className="ml-auto"
                  >
                  ...
                  <div className="mt-6 md:mt-0 space-y-4 flex flex-col items-start">
                    <div className="bg-muted/50 p-4 rounded-lg w-full">
                      ...
                      <p className="text-sm mt-1">
                        You will be charged ${currentPlan.nextBillingAmount
                          .toFixed(2)}
                      </p>
                    </div>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              ...
                              You'll lose access to premium features after the
                          ...
                          <div className="py-4">
                            <Alert variant="destructive" className="mb-4">
                              ...
                              <AlertDescription>
                                ...
                                {currentPlan.renewalDate}, after which your
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your recent subscription charges and payments
                </CardDescription>
              </CardHeader>
              <CardContent>
