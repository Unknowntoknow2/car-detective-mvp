  ...
  const premiumFeatures = [
    {
      ...
      description:
        "Complete CARFAX® history report with accident records, service history, and ownership details.",
      icon: "📋",
    ...
    },
    {
      ...
      description:
        "Get detailed market analysis with price trends and future value projections.",
      icon: "📈",
    ...
    },
    {
      ...
      description:
        "Evaluate your vehicle condition across multiple categories for more precise valuation.",
      icon: "⭐",
    ...
    },
    {
      ...
      description:
        "Verify the vehicle title status and check for any liens or issues.",
      icon: "🔍",
    ...
    },
    {
      ...
      description:
        "Detailed breakdown of anticipated ownership costs including maintenance, insurance, and depreciation.",
      icon: "💵",
    ...
    },
    {
      ...
      description:
        "Downloadable and printable comprehensive PDF report with all valuation details.",
      icon: "📑",
      categories: ["all", "report"],
    },
    {
      ...
      description:
        "12-month value projection to help you time your sale or purchase.",
      icon: "🔮",
      categories: ["all", "market"],
    },
  ];
      ...
      <main>
        ...
        <section className="bg-slate-50 py-12 md:py-20 border-b">
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              <div className="absolute w-72 h-72 rounded-full bg-primary/10 -right-20 -top-10 filter blur-3xl">
              </div>
              <div className="relative">
                <PremiumCard />
              </div>
                ...
                <TabsContent value="compare">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        See what additional features and benefits you get with
        ...
        <section className="container mx-auto py-16 px-4">
          <div className="max-w-3xl mx-auto text-center mb-10">
            ...
            <p className="text-xl text-gray-600">
              Enter your vehicle information to get a comprehensive valuation
              report
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter your VIN, license plate, or vehicle details to get
                  started
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div className="space-y-4">
                      <div className="grid w-full items-center gap-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Your VIN can be found on your registration, insurance
                          card, or driver's side dashboard
                        </p>
                      </div>
