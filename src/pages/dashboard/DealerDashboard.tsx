...
import { ChevronRight, Car, Users, DollarSign, CalendarClock } from 'lucide-react';

export default function DealerDashboard() {
  const { user } = useAuth();
  const dealerName = user?.user_metadata?.dealership_name || user?.user_metadata?.full_name || 'Dealer';

  return (
    <div className="container mx-auto p-6">
      <div className="flex flex-col gap-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{dealerName} Dashboard</h1>
                  ...
                  <div className="rounded-lg border">
                    <div className="flex flex-col">
                      <div className="flex items-center justify-between p-4 border-b">
                        <div className="flex flex-col">
                          <p className="font-medium">Welcome to your dealer dashboard</p>
                          <p className="text-sm text-muted-foreground">Your account has been set up successfully</p>
                        </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm mx-auto mt-2">
                    Leads will appear here when customers express interest in your vehicles.
                  </p>
                </div>
              </CardContent>
            </Card>
