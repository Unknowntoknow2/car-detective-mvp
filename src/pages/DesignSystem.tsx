...
import {
  ...
  HeadingL,
  HeadingXL,
} from "@/components/ui-kit/typography";
...
const DesignSystem = () => {
  ...
  const mockValuationData = {
    ...
    adjustments: [
      {
        factor: "Mileage",
        impact: -500,
        description: "Below average mileage for the year",
      },
      {
    ...
    aiCondition: {
      ...
      aiSummary:
        "Vehicle appears to be in good condition with only minor cosmetic issues detected. Interior shows normal wear for the vehicle age and mileage.",
    },
  };
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <CDButton variant="primary" icon={<Check className="h-4 w-4" />}>
            With Icon
          </CDButton>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <CDCard>
            ...
            <CDCardBody>
              <BodyM>
                This is a basic card component with header and body.
              </BodyM>
            </CDCardBody>
          </CDCard>
          ...
          <CDCard>
            ...
            <CDCardBody>
              <BodyM className="mb-4">
                Cards can contain various UI elements like buttons and badges.
              </BodyM>
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <CDBadge variant="info" icon={<InfoIcon className="h-3 w-3" />}>
            With Icon
          </CDBadge>
          <CDBadge variant="error" icon={<AlertCircle className="h-3 w-3" />}>
            Alert
          </CDBadge>
        </div>
      </section>
            ...
            content={
              <div className="max-w-xs">
                ...
                <p className="text-xs mt-1">
                  You can include multiple paragraphs and formatting in
                  tooltips.
                </p>
              </div>
            }
