    ...
    async function fetchOfferByToken() {
      ...
      try {
        ...
        if (leadError) {
          ...
          setError(
            "Could not find this offer. The link may be invalid or expired.",
          );
          setLoading(false);
          return;
        }
    ...
    return (
      <div className="container mx-auto max-w-md p-6">
        <Card>
          ...
          <CardContent>
            <p>
              We couldn't find any vehicle information associated with this
              link.
            </p>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="font-medium">
                {getConditionLabel(vehicle.condition_score)}
              </p>
            </div>
            {vehicle.state && (
              <div>
          ...
          <Card className="bg-slate-50">
            <CardContent className="p-6 text-center">
              <p className="text-muted-foreground">
                No offers have been made yet for this vehicle.
              </p>
            </CardContent>
          </Card>
        )
