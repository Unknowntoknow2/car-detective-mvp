...
export default function ResultPage() {
  ...
  const formattedMileage = valuationData?.mileage
    ? formatNumber(valuationData.mileage, 0)
    : "0";
        ...
        <div className="flex-1 bg-gray-50 flex items-center justify-center">
          <div className="max-w-md mx-auto text-center p-6">
            ...
            <p className="text-gray-600 mb-6">
              The page you're looking for doesn't exist or has been moved. If
              you were trying to view a valuation result, it may have expired or
              been deleted.
            </p>
            ...
            <CardContent>
              ...
              <div className="mt-8 border-t pt-6">
                ...
                <ValuationFactorsGrid
                  ...
                  onChange={(id, value) => {
                    toast.info(
                      `${id} updated to ${value}. Recalculating valuation...`,
                    );
                    // In a real implementation, this would update the valuation
                  }}
                />
              ...
              <div className="mt-8 border-t pt-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  No dealer offers yet. Share your valuation with dealers to
                  receive offers.
                </p>
              </div>
              ...
              <div className="mt-8 border-t pt-6 bg-slate-50 p-6 rounded-lg">
                ...
                <p className="text-muted-foreground mb-4">
                  Unlock advanced valuation insights, CARFAX integration, and
