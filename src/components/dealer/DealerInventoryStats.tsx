...
export const DealerInventoryStats = () => {
        ...
        if (vehicles && vehicles.length > 0) {
          vehicles.forEach((vehicle) => {
            ...
            if (vehicle.fuel_type) {
              ...
              else if (fuelType === "gas" || fuelType === "gasoline") {
                newStats.byFuelType.gas++;
  ...
  const conditionChartData: ChartData[] = [
    {
      name: "Excellent",
      value: stats.byCondition.excellent,
      color: conditionColors.excellent,
    },
    {
      name: "Good",
      value: stats.byCondition.good,
      color: conditionColors.good,
    },
    {
      name: "Fair",
      value: stats.byCondition.fair,
      color: conditionColors.fair,
    },
    {
      name: "Poor",
      value: stats.byCondition.poor,
  ...
  const fuelTypeChartData: ChartData[] = [
    {
      name: "Electric",
      value: stats.byFuelType.electric,
      color: fuelTypeColors.electric,
    },
    { name: "Gas", value: stats.byFuelType.gas, color: fuelTypeColors.gas },
    {
      name: "Hybrid",
      value: stats.byFuelType.hybrid,
      color: fuelTypeColors.hybrid,
    },
  ].filter((item) => item.value > 0);
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {[1, 2, 3].map((item) => (
          <Card
            key={item}
            className="rounded-2xl bg-card/80 shadow overflow-hidden"
          >
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground mb-6">
          Add your first vehicle to see inventory stats and breakdowns
        </p>
        <button
          className="px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors"
          onClick={() => globalThis.location.href = "/dealer/inventory/add"}
        >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-xs max-w-60">
                        Breakdown of your inventory by condition category
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                  ...
                  <ul className="mt-2 space-y-1 text-sm">
                    <li className="flex items-center">
                      <span
                        ...
                        style={{ backgroundColor: conditionColors.excellent }}
                      >
                      </span>
                    ...
                    <li className="flex items-center">
                      <span
                        className="w-3 h-3 inline-block mr-2 rounded-full"
                        style={{ backgroundColor: conditionColors.good }}
                      >
                      </span>
                    ...
                    <li className="flex items-center">
                      <span
                        className="w-3 h-3 inline-block mr-2 rounded-full"
                        style={{ backgroundColor: conditionColors.fair }}
                      >
                      </span>
                    ...
                    <li className="flex items-center">
                      <span
                        className="w-3 h-3 inline-block mr-2 rounded-full"
                        style={{ backgroundColor: conditionColors.poor }}
                      >
                      </span>
          ...
          <Card className="rounded-2xl bg-card/80 shadow-sm hover:shadow-md transition-shadow h-full">
              ...
              <CardTitle className="text-base font-medium flex items-center gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-xs max-w-60">
                        Breakdown of your inventory by fuel type
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  <div className="text-2xl font-bold">
                    {stats.byFuelType.electric + stats.byFuelType.gas +
                      stats.byFuelType.hybrid}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    With Fuel Type
                  </div>
                  <ul className="mt-2 space-y-1 text-sm">
                    <li className="flex items-center">
                      <span
                        className="w-3 h-3 inline-block mr-2 rounded-full"
                        style={{ backgroundColor: fuelTypeColors.electric }}
                      >
                      </span>
                    ...
                    <li className="flex items-center">
                      <span
                        className="w-3 h-3 inline-block mr-2 rounded-full"
                        style={{ backgroundColor: fuelTypeColors.gas }}
                      >
                      </span>
                    ...
                    <li className="flex items-center">
                      <span
                        className="w-3 h-3 inline-block mr-2 rounded-full"
                        style={{ backgroundColor: fuelTypeColors.hybrid }}
                      >
                      </span>
              ...
              <CardTitle className="text-base font-medium flex items-center gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-xs max-w-60">
                        Recent inventory activity and pending items
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              ...
              <div className="space-y-6">
                ...
                <div className="pt-2">
                  <button
                    ...
                    onClick={() => globalThis.location.href = "/dealer/inventory"}
                  >
                    View All Inventory
                  </button>
                </div>
