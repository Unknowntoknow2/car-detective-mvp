...
const mockVehicles: DealerVehicle[] = [
  {
    ...
    photos: ['https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&q=80&w=870&ixlib=rb-4.0.3'],
    condition: 'Excellent',
    fuel_type: 'Gasoline',
  ...
  },
  {
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    photos: ['https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=870&ixlib=rb-4.0.3'],
    condition: 'Good',
    fuel_type: 'Hybrid',
    transmission: 'CVT',
    zip_code: '94103'
  },
  {
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    photos: ['https://images.unsplash.com/photo-1562618774-5375fe86c36e?auto=format&fit=crop&q=80&w=870&ixlib=rb-4.0.3'],
    condition: 'Excellent',
    fuel_type: 'Electric',
    transmission: 'Automatic',
    zip_code: '94103'
  },
  {
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    photos: ['https://images.unsplash.com/photo-1584345604476-8ec5e12e42dd?auto=format&fit=crop&q=80&w=870&ixlib=rb-4.0.3'],
    condition: 'Good',
    fuel_type: 'Gasoline',
    transmission: 'Manual',
    zip_code: '94103'
  },
  {
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    photos: ['https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&q=80&w=870&ixlib=rb-4.0.3'],
    condition: 'Excellent',
    fuel_type: 'Gasoline',
    transmission: 'Automatic',
    zip_code: '94103'
  },
  {
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    photos: ['https://images.unsplash.com/photo-1518987048-93e29699e79a?auto=format&fit=crop&q=80&w=870&ixlib=rb-4.0.3'],
    condition: 'Good',
    fuel_type: 'Gasoline',
    transmission: 'Automatic',
    zip_code: '94103'
...
type SortOption = 'newest' | 'oldest' | 'price-high' | 'price-low' | 'mileage-low' | 'mileage-high';
...
export const DealerVehicleList: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h2 className="text-2xl font-bold">My Inventory ({sortedVehicles.length})</h2>
