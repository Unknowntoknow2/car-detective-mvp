    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatsCard
          ...
          icon={<BarChart />}
          trend={data.totalValuations > 0
            ? { value: 12, isPositive: true, label: "vs last month" }
            : undefined}
        />
        <StatsCard
          ...
          icon={<Users />}
          trend={data.revenueTotal > 0
            ? { value: 8, isPositive: true, label: "vs last month" }
            : undefined}
        />
        <StatsCard
          title="Active Users"
        ...
        <StatsCard
          ...
          icon={<PieChart />}
          trend={data.aiConfidence > 0
            ? { value: 5, isPositive: true, label: "improvement" }
            : undefined}
        />
      </div>
            ...
            <div className="space-y-1">
              {data.topZipCodes.map((item, index) => (
                <LeaderboardRow
                  ...
                  value={`${
                    ((item.count / data.totalValuations) * 100).toFixed(1)
                  }%`}
                  highlight={index === 0}
                />
              ))}
