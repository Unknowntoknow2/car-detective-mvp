...
const AuthForm = ({ mode }: { mode: AuthMode }) => {
  ...
  const getDescription = () => {
    switch (mode) {
      case "signup":
        return "Create a new account to save your valuations";
      case "login":
        return "Sign in to access your saved valuations";
      case "forgot-password":
        return "Receive a password reset link via email";
      case "reset-password":
        return "Create a new password for your account";
      case "forgot-email":
        return "Find your account username using your phone number";
      default:
        return "";
    }
  };
  ...
  const renderForm = () => {
    switch (mode) {
      ...
      case "forgot-email":
        return (
          <ForgotEmailForm isLoading={isLoading} setIsLoading={setIsLoading} />
        );
      case "reset-password":
        return (
          <ResetPasswordForm
  ...
  const getToggleLink = () => {
    if (mode === "signup") {
      ...
      mode === "forgot-password" || mode === "forgot-email" ||
      mode === "reset-password"
    ) {
      return (
        <Button
