...
export function ValuationResults({
  ...
  const selectedConditionRating: ConditionRatingOption = {
    ...
    value: vehicleInfo.condition
      ? ["Excellent", "Very Good", "Good", "Fair", "Poor"].indexOf(
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Price range: {formatCurrency(calculatedPriceRange[0])} -{" "}
            ...
            <TabsContent value="overview" className="space-y-4 pt-4">
              <div className="grid gap-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">
                    {formatCurrency(adjustments.reduce((sum, adj) =>
                      sum + (adj.impact || 0), 0))}
                  </span>
                </div>
              </div>
              ...
              {adjustments.length > 0
                ...
                : (
                  <p className="text-sm text-muted-foreground">
                    No adjustments applied to this valuation.
                  </p>
                )}
            </TabsContent>
          </Tabs>
