...
export function ShareableLink({ valuationId }: ShareableLinkProps) {
  ...
  const handleShare = (platform: "twitter" | "linkedin") => {
    ...
    let platformUrl;
    if (platform === "twitter") {
      platformUrl = `https://twitter.com/intent/tweet?url=${
    ...
    if (platformUrl) {
      globalThis.open(platformUrl, "_blank", "width=600,height=400");
    }
  };
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Share this public link with others to let them view your valuation
              report.
            </DialogDescription>
          </DialogHeader>
