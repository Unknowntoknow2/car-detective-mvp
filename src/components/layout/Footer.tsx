...
export function Footer() {
  ...
  return (
    <footer className="border-t py-8 bg-surface-dark">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="flex space-x-4">
              {['twitter', 'facebook', 'instagram', 'linkedin'].map((platform) => (
                <a 
                  key={platform} 
                  href={`#${platform}`} 
                  className="h-8 w-8 rounded-full bg-surface flex items-center justify-center text-text-secondary hover:text-primary transition-colors"
                >
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-medium mb-4 text-text-primary">Quick Links</h3>
          ...
          {/* Legal */}
          <div>
            <h3 className="font-medium mb-4 text-text-primary">Legal</h3>
            <ul className="space-y-2">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mt-12 pt-6 border-t border-border">
