...
export function ReferralModal({ isOpen, onClose }: ReferralModalProps) {
  ...
  const referralUrl = myReferralToken
    ? `${globalThis.location.origin}/signup?ref=${myReferralToken}`
    : "";
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Invite friends to Car Detective and earn rewards when they use the
            platform
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="email" className="mt-4">
          ...
          <TabsContent value="email" className="space-y-4 mt-4">
            ...
            <div className="bg-muted/50 p-4 rounded-md text-sm">
              ...
              <p>
                Your friend will receive an email with your invitation. You'll
                earn:
              </p>
