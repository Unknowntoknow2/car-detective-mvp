...
export function DealerOffersTab(
  { vehicleData, valuationId = "mock-id" }: DealerOffersTabProps,
) {
  const { user } = useAuth();
  ...
  const handleRequestOffers = async () => {
    ...
    try {
      ...
      toast.success(
        "Dealer offer requests sent successfully! You'll receive offers soon.",
      );
    } catch (error) {
      ...
      >
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 text-center">
          ...
          <p className="text-amber-700 mb-4">
            ...
            entry to request dealer offers.
          </p>
        </div>
      </TabContentWrapper>
    );
  ...
  if (isDealer) {
    return (
      <TabContentWrapper
        ...
        description={`Make an offer for this ${vehicleData.year} ${vehicleData.make} ${vehicleData.model} ${
          vehicleData.trim || ""
        }`}
      >
  ...
  return (
    <TabContentWrapper
      title="Dealer Offers"
      description={`Get purchase offers for your ${vehicleData.year} ${vehicleData.make} ${vehicleData.model} ${
        vehicleData.trim || ""
      }`}
    >
      {!offersRequested
          ...
          <div className="space-y-6">
            <div className="p-6 bg-slate-50 rounded-lg border border-slate-200">
              <h3 className="text-lg font-semibold mb-4">
                Request Offers from Local Dealers
              </h3>
              <p className="text-slate-600 mb-6">
                We'll send your vehicle details to our network of certified
                dealers in your area. You'll receive actual purchase offers with
              ...
              <div className="grid gap-4 md:grid-cols-3 mb-6">
                <div className="bg-white p-4 rounded border border-slate-200 flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-slate-500">
                    Only trusted dealerships in our network
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded border border-slate-200 flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-slate-500">
                    Review offers with no pressure to sell
                  </p>
                </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
              ...
              <div className="text-sm text-blue-800">
                ...
                <ol className="list-decimal list-inside mt-1 space-y-1">
                  <li>
                    We send your vehicle details to certified dealers in your
                    area
                  </li>
                  <li>
                    Dealers evaluate your vehicle and submit purchase offers
                  </li>
                  <li>You receive multiple offers within 24-48 hours</li>
                  <li>
                    You can accept any offer or decline all with no obligation
                  </li>
                </ol>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-6 bg-green-50 border border-green-100 rounded-lg">
              ...
              <p className="text-green-700 mb-4">
                We've sent your vehicle details to our dealer network. You
                should start receiving offers within 24-48 hours. We'll notify
                you by email when new offers arrive.
              </p>
            </div>
