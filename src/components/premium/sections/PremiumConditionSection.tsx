...
export function PremiumConditionSection(
  { onSaveCondition }: PremiumConditionSectionProps,
) {
    ...
    <Card className="border shadow-sm">
      ...
      <CardContent className="space-y-6">
        <p className="text-muted-foreground">
          Our premium condition assessment allows you to rate your vehicle's
          condition in detail. Each 5% change in condition rating affects your
          vehicle's value differently.
        </p>
