    ...
    >
          ...
          <AnimatedCard className="md:col-span-2">
            <CardContent className="p-6">
              ...
              <p className="text-slate-600 mb-6">
                Select your vehicle features to see how they impact the overall
                value.
              </p>
              ...
              {calculationDone
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-green-600">
                          +${Math.round(featureAdjustments.totalAdjustment)
                            .toLocaleString()}
                        </span>
                      </div>
                ...
                : (
                  <div className="h-full flex flex-col items-center justify-center text-center p-6 text-slate-500">
                    ...
                    <p>
                      Configure your vehicle and click "Calculate Value" to see
      ...
      <TabsContent value="dealer-offers">
        ...
        >
          ...
          <p className="text-slate-600 max-w-md mx-auto mb-6">
            Upgrade to premium to see what dealers in your area are willing to
      ...
      <TabsContent value="market-forecast">
        ...
        >
          ...
          <p className="text-slate-600 max-w-md mx-auto mb-6">
            Upgrade to premium to see how your vehicle's value will change over
            the next 12 months.
          </p>
          <AnimatedButton
            className="mt-4"
