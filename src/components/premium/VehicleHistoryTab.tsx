...
export function VehicleHistoryTab(
  { vin, valuationId, historyData }: VehicleHistoryTabProps,
) {
  ...
  const fetchHistoryData = async () => {
    ...
    try {
      ...
      toast.error(
        "Failed to generate vehicle history report. Please try again.",
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <Card className="p-6 text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-slate-600 mb-6">
              Get detailed insights about this vehicle's past including
              accidents, service records, ownership history, and more.
            </p>
            <Button
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Full ownership and registration history.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Detailed accident and damage reports.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Maintenance and service history details.
                </p>
              </div>
            </div>
          </Card>
  ...
  if (isLoading) {
    return (
      <Card className="p-6 text-center">
        ...
        <p className="text-slate-600 mb-6">
          Please wait while we compile your comprehensive vehicle history
          report...
        </p>
  ...
  return (
    <div className="space-y-6">
      <Card className="p-6">
        ...
        <div className="border-t border-slate-200 pt-6">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            {reportData.estimatedValueImpact !== 0 && (
              <span
                className={reportData.estimatedValueImpact < 0
                  ? "text-red-600"
                  : "text-green-600"}
              >
                {reportData.estimatedValueImpact > 0 ? "+" : ""}
      ...
      <p className="text-sm text-slate-500 italic">
        CARFAX® Vehicle History Reports are based on information supplied to
        CARFAX. CARFAX does not have the complete history of every vehicle.
      </p>
    </div>
  );
}
