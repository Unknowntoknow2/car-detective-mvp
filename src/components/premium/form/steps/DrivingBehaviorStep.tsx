    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Your driving habits can affect vehicle wear and tear, which impacts its value.
          Select the option that best describes your driving style.
        </p>
      </div>
      ...
      <Card>
        <CardContent className="pt-6">
          ...
          >
            <div className="flex items-start space-x-2">
              ...
              <div className="grid gap-1.5">
                ...
                <p className="text-sm text-muted-foreground">
                  I drive cautiously, avoid hard braking, and rarely exceed speed limits.
                  I maintain consistent speeds and avoid rapid acceleration.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="grid gap-1.5">
                ...
                <p className="text-sm text-muted-foreground">
                  I drive normally, sometimes in city traffic and sometimes on highways.
                  I occasionally accelerate quickly but generally maintain moderate driving habits.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="grid gap-1.5">
                ...
                <p className="text-sm text-muted-foreground">
                  I enjoy driving dynamically, with frequent acceleration and higher speeds when conditions allow.
                  I may drive more aggressively in traffic situations.
                </p>
              </div>
            </div>
          </RadioGroup>
          ...
          <div className="mt-6 pt-6 border-t">
            <h3 className="text-sm font-medium mb-2">How This Affects Your Vehicle's Value</h3>
            <div className="text-sm text-muted-foreground space-y-2">
              <p>
                <span className="font-medium">Careful driving</span>: May reduce wear on brakes, transmission, 
                and engine components, potentially increasing vehicle value by 2-5%.
              </p>
              <p>
                <span className="font-medium">Average driving</span>: Reflects typical usage patterns and 
                has a neutral impact on valuation.
              </p>
              <p>
                <span className="font-medium">Spirited driving</span>: Can lead to increased wear on drivetrain 
                components and may reduce vehicle value by 1-3%.
              </p>
            </div>
          </div>
        </CardContent>
