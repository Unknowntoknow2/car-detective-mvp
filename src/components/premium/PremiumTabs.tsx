...
export function PremiumTabs(
  { showFreeValuation = false, onSubmit }: PremiumTabsProps,
) {
  ...
  return (
    <Tabs defaultValue="premium" className="w-full">
        ...
        <TabsContent value="free" className="mt-6 p-6 border rounded-lg">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Get a quick estimate of your vehicle's value with our free basic
              valuation tool.
            </p>
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="bg-gray-100 text-gray-600 rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ✓
                </span>
      ...
      <TabsContent
        value="premium"
        className="mt-6 p-6 border border-amber-200 bg-amber-50 rounded-lg"
      >
        <div className="space-y-4">
          ...
          <p className="text-amber-700">
            Get the most accurate and comprehensive valuation with our premium
            service.
          </p>
          <ul className="space-y-2">
            <li className="flex items-start">
              ...
              <span className="ml-2">
                Full CARFAX® Vehicle History Report ($44 value)
              </span>
            </li>
            <li className="flex items-start">
              <span className="bg-amber-200 text-amber-800 rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <span className="ml-2">
                Detailed market analysis with similar vehicles
              </span>
            </li>
            <li className="flex items-start">
              <span className="bg-amber-200 text-amber-800 rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <span className="ml-2">
                Connect with dealers for competitive offers
              </span>
            </li>
            <li className="flex items-start">
              <span className="bg-amber-200 text-amber-800 rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5">
