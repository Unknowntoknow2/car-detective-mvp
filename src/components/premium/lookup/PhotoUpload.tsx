...
interface PhotoUploadProps {
  ...
  isLoading?: boolean;
  handleUpload?: (formData: ManualEntryFormData) => void;
}
...
export const PhotoUpload: React.FC<PhotoUploadProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (selectedFiles.length > 0) {
      ...
      } else if (onPhotoAnalysisComplete) {
            ...
            : (
              <label className="flex flex-col items-center justify-center h-36 cursor-pointer">
                ...
                <p className="text-xs text-slate-500">
                  Take clear photos of the exterior, interior, and VIN plate
                </p>
                <Input
                  type="file"
                  accept="image/jpeg,image/png,image/webp,image/heic"
        ...
        <div className="flex items-start gap-2 text-xs text-slate-500 mt-2">
          ...
          <div>
            <p>
              ...
              determine make, model, year, and condition.
            </p>
