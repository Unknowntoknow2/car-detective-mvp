      ...
      <div className="space-y-3">
        <div className="relative group">
          <Input 
            ...
            className={`text-lg font-mono tracking-wide h-12 pr-10 transition-colors ${
              (touched && validationResult.error) ? 'border-red-300 focus-visible:ring-red-200 bg-red-50/30' : 
