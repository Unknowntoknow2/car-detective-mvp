...
export function PremiumCard() {
  return (
    <>
      <div className="absolute inset-0 bg-black/10 backdrop-blur-sm rounded-2xl transform -rotate-3 z-0">
      </div>
      <div className="absolute inset-0 bg-gradient-to-tr from-primary-dark/20 to-transparent rounded-2xl transform rotate-3 z-0">
      </div>
      <DesignCard
        variant="glass"
                ...
                >
                  <div
                    className={`w-full rounded-t-sm ${
                      i === 4 ? "bg-primary" : "bg-border-dark/80"
                    }`}
                    style={{ height: `${height}%` }}
                  >
                  </div>
