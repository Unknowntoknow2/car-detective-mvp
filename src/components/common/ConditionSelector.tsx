...
const conditionOptions: ConditionOption[] = [
  {
    ...
    label: "Poor",
    description:
      "Vehicle has significant mechanical or cosmetic issues. May have high mileage (>150k), visible damage, engine problems, or rust.",
    improvementTips:
      "Address major mechanical issues, repair significant body damage, provide maintenance records.",
  },
  {
    value: 50,
    label: "Fair",
    description:
      "Vehicle has noticeable wear and tear. May have minor dents, worn interior, higher mileage (100-150k), or require some maintenance.",
    improvementTips:
      "Fix minor dents and scratches, perform interior detailing, replace worn tires or brakes.",
  },
  {
    value: 75,
    label: "Good",
    description:
      "Vehicle in good running condition with minimal issues. Some regular wear, recent maintenance, clean history, moderate mileage (50-100k).",
    improvementTips:
      "Complete all scheduled maintenance, repair minor cosmetic issues, detail interior and exterior.",
  },
  {
    value: 90,
    label: "Excellent",
    description:
      "Vehicle in exceptional condition. Lower mileage (<50k), well-maintained, minimal wear, no mechanical issues, clean history report.",
    improvementTips:
      "Obtain complete service history documentation, consider certification, provide all records to buyer.",
  },
];
      ...
      {label && (
        <div className="flex items-center justify-between">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent side="right" className="max-w-xs">
                    <p className="text-sm">
                      Select the condition that best describes your vehicle's
                      current state
                    </p>
                  </TooltipContent>
                </Tooltip>
          ...
          <span className="text-sm text-muted-foreground">
            {conditionOptions.find((opt) => opt.value === currentValue)
              ?.label || "Not selected"}
          </span>
        </div>
      )}
                  ...
                  <HoverCardContent side="top" className="w-80 p-0">
                    <div className="space-y-2 p-4">
                      <h3 className="font-medium text-sm">
                        {option.label} Condition ({option.value}%)
                      </h3>
