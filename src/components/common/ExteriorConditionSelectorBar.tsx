...
export interface ExteriorConditionSelectorBarProps {
  value: 'excellent' | 'good' | 'fair' | 'poor';
  onChange: (value: 'excellent' | 'good' | 'fair' | 'poor') => void;
}

const exteriorConditionOptions = [
...
export function ExteriorConditionSelectorBar({ value, onChange }: ExteriorConditionSelectorBarProps) {
  return (
