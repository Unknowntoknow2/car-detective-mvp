...
interface AudioEntertainmentTabProps {
  formData: FollowUpAnswers;
  updateFormData: (updates: Partial<FollowUpAnswers>) => void;
  baseValue: number;
}

export function AudioEntertainmentTab({ formData, updateFormData, baseValue }: AudioEntertainmentTabProps) {
  const audioFeatures = getFeaturesByCategory('audio');
