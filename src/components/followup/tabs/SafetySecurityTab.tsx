...
interface SafetySecurityTabProps {
  formData: FollowUpAnswers;
  updateFormData: (updates: Partial<FollowUpAnswers>) => void;
  baseValue: number;
}

export function SafetySecurityTab({ formData, updateFormData, baseValue }: SafetySecurityTabProps) {
  ...
  const categoryValue = calculateEnhancedFeatureValue(
    selectedFeatures.filter(id => safetyFeatures.some(f => f.id === id)),
    baseValue
  );
