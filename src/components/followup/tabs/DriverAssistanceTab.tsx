...
interface DriverAssistanceTabProps {
  formData: FollowUpAnswers;
  updateFormData: (updates: Partial<FollowUpAnswers>) => void;
  baseValue: number;
}

export function DriverAssistanceTab({ formData, updateFormData, baseValue }: DriverAssistanceTabProps) {
  const adasFeatures = getFeaturesByCategory('adas');
  ...
  const categoryValue = calculateEnhancedFeatureValue(
    selectedFeatures.filter(id => adasFeatures.some(f => f.id === id)),
    baseValue
  );
