...
import AuctionHistorySection from '@/components/lookup/AuctionHistorySection';
        ...
        <main className="flex-1 bg-gray-50 flex items-center justify-center p-4">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">
              {error || "Could not find the requested valuation."}
            </p>
  ...
  if (result) {
    return (
      <div className="space-y-6">
        ...
        {/* Add the Auction History Section */}
        {result.vin && <AuctionHistorySection vin={result.vin} />}
      </div>
    );
  }
