    ...
    if (!hasShownIntro && valuationId) {
      const timer = setTimeout(() => {
        toast.custom((t) => {
          ...
          return (
            <div
              className={`${visibleClass} max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex`}
            >
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Have questions about your car's value? I can help explain
                      your valuation or suggest ways to increase it.
                    </p>
