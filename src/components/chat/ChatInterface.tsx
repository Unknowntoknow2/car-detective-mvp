...
export function ChatInterface({
  ...
  const { messages, isLoading, error, sendMessage, regenerateLastResponse } =
    useValuationChat(valuationId);
  ...
  useEffect(() => {
    if (userRole === "dealer" && messages.length > 0) {
      ...
      if (lastMessage.role === "assistant") {
        if (
          lastMessage.content.includes("inventory") ||
          lastMessage.content.includes("vehicle")
        ) {
          setSuggestedQuestions([
          ...
          lastMessage.content.includes("lead") ||
          lastMessage.content.includes("customer")
        ) {
          setSuggestedQuestions([
          ...
          lastMessage.content.includes("trend") ||
          lastMessage.content.includes("market")
        ) {
          setSuggestedQuestions([
            ...
            ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-xs text-muted-foreground">
                  I can explain your valuation, offer advice on improving your
                  car's value, or help with dealer negotiations.
                </p>
              </div>
            )
            : (
