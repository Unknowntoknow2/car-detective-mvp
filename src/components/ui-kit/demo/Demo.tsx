  ...
  const tabItems = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <BodyM>
            This 2023 Toyota Camry offers excellent fuel efficiency, advanced
            safety features, and a comfortable interior. With its reputation for
            reliability and performance, this sedan provides exceptional value
            for everyday driving and long trips alike.
          </BodyM>
        </div>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <BodyM>
            This vehicle has a clean history with no reported accidents or
            damage. It has been regularly maintained according to the
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="space-y-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <BodyM>
              Body M - This is standard body text used for most paragraphs.
            </BodyM>
            <BodyS>
              Body S - This is smaller body text used for supporting
              information.
            </BodyS>
            <Caption>
              Caption - Used for supplementary text and meta information.
            </Caption>
        ...
        <section className="space-y-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <CDCard>
              ...
              <CDCardBody>
                <BodyM>
                  This is a basic card with a header, body, and footer. Cards
                  are used to group and display content in a way that is easy to
                  scan and read.
                </BodyM>
              </CDCardBody>
              <CDCardFooter>
            ...
            <CDCard variant="outline">
              ...
              <CDCardBody>
                <BodyM>
                  This is an outline card with reduced visual weight. It's
                  useful for secondary information or when you want to
                  de-emphasize certain content.
                </BodyM>
              </CDCardBody>
              <CDCardFooter>
            ...
            >
              ...
              <CDCardBody>
                <BodyM>
                  This is an interactive card that can be clicked. It's useful
                  for navigation, selecting options, or triggering actions.
                </BodyM>
              </CDCardBody>
              <CDCardFooter>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 flex-wrap">
                ...
                <CDTooltip content="This is a tooltip" side="right">
                  <CDButton variant="secondary" size="sm">
                    Right Tooltip
                  </CDButton>
                </CDTooltip>
                ...
                <CDTooltip
                  content={
                    <div className="p-1 max-w-xs">
                      ...
                      <BodyS>
                        Tooltips can contain complex content including headers,
                        paragraphs, and even interactive elements.
                      </BodyS>
                    </div>
                  }
                  side="top"
            ...
            >
              <CDModalBody>
                <BodyM>
                  ...
                  valuation. The estimated value is based on current market
                  conditions, vehicle condition, and comparable sales in your
                  area.
                </BodyM>
      ...
      <CDFooter
        ...
        copyright={
          <>
            ...
            <div className="mt-2">
              <a href="#" className="text-sm hover:text-primary mr-4">
                Privacy Policy
              </a>
