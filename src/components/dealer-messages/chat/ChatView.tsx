...
export const ChatView: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    if (!selectedLeadId || (!newMessage.trim() && attachments.length === 0)) {
      return;
    }
      ...
      <div className="h-full flex items-center justify-center bg-gray-50">
        <div className="text-center p-8">
          ...
          <p className="text-gray-500">
            Choose a lead from the sidebar to view messages
          </p>
        </div>
      </div>
    );
                ...
                <div key={dateKey}>
                  ...
                  {messageGroups[dateKey].map((message, index) => {
                    const prevMessage = index > 0
                      ? messageGroups[dateKey][index - 1]
                      : null;
                    const isSameAuthor = prevMessage &&
                      prevMessage.sentByDealer === message.sentByDealer;
                    const timeGap = prevMessage
                      ? (new Date(message.timestamp).getTime() -
                        new Date(prevMessage.timestamp).getTime()) / (1000 * 60)
                      : Infinity;
                    ...
                    return (
                      <motion.div
                        ...
                        className={`flex ${
                          message.sentByDealer ? "justify-end" : "justify-start"
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className={`text-xs px-3 pb-1 flex items-center justify-end ${
                              message.sentByDealer
                                ? "text-blue-200"
                                : "text-gray-500"
                            }`}
                  ...
                  >
                    <div className="bg-white text-gray-800 rounded-lg p-3 shadow-sm">
                      <div className="flex items-center">
                        ...
                        <span className="animate-pulse animation-delay-150">
                          •
                        </span>
                        <span className="animate-pulse animation-delay-300">
                          •
                        </span>
                      </div>
                    </div>
