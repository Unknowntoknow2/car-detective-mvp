      ...
      >
        ...
        <div className="py-12 md:py-0">
          ...
          <p className="text-xl opacity-90 mb-8">
            {quote ||
              "Get the most accurate vehicle valuation with our AI-powered platform."}
          </p>

          <div className="hidden md:block">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              <p className="italic text-white/90">
                "Car Detective provided me with the most accurate valuation for
                my vehicle. The process was simple and the insights were
                invaluable when negotiating with dealers."
              </p>
