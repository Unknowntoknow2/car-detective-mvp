...
def preprocess_input(vehicle: Dict) -> pd.DataFrame:
    ...
    if "valuation_video" in vehicle and vehicle["valuation_video"]:
        ...
        if "ai_condition_score" in video_data and video_data["ai_condition_score"]:
        ...
        if "video_quality" in video_data and video_data["video_quality"]:
        ...
        if "ai_detected_issues" in video_data and video_data["ai_detected_issues"]:
    ...
    if "mileage" in vehicle:
        ...
        if isinstance(vehicle["mileage"], dict) and "value" in vehicle["mileage"]:
            ...
            base_data["mileage_verified"] = vehicle["mileage"]["verified"]
        else:
