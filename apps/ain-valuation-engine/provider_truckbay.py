...
# Truckbay does not have a public API; this is a template for future integration or manual export.

class TruckbayProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for Truckbay listings if needed.
