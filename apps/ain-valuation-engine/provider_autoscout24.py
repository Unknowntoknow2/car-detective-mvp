...
# AutoScout24 does not have a public API; this is a template for future integration or manual export.

class AutoScout24Provider(ListingProvider):
...
# Note: Use manual export or third-party tools for AutoScout24 listings if needed.
