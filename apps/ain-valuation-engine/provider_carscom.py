...
# Cars.com does not have a public API; this is a template for future integration or manual export.

class CarsComProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for Cars.com listings if needed.
