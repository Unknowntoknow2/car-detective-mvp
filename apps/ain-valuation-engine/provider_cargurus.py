...
# CarGurus does not have a public API; this is a template for future integration or manual export.

class CarGurusProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for CarGurus listings if needed.
