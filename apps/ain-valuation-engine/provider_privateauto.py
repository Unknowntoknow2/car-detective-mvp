...
# PrivateAuto does not have a public API; this is a template for future integration or manual export.

class PrivateAutoProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for PrivateAuto listings if needed.
