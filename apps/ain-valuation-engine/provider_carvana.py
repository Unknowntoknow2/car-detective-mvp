...
# Carvana does not have a public API; this is a template for future integration or manual export.

class CarvanaProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for Carvana listings if needed.
