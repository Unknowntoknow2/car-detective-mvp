...
# CarMax does not have a public API; this is a template for future integration or manual export.

class CarMaxProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for CarMax listings if needed.
