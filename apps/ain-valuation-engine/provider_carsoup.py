...
# CarSoup does not have a public API; this is a template for future integration or manual export.

class CarSoupProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for CarSoup listings if needed.
