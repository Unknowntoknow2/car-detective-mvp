...
# Oodle does not have a public API; this is a template for future integration or manual export.

class OodleProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for Oodle listings if needed.
