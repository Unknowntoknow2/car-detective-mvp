...
# TRED does not have a public API; this is a template for future integration or manual export.

class TredProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for TRED listings if needed.
