...
# Letgo (legacy) does not have a public API; this is a template for future integration or manual export.

class LetgoProvider(ListingProvider):
...
# Note: Use manual export or third-party tools for Letgo listings if needed.
