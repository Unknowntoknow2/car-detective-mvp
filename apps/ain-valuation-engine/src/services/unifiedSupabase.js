...
class SupabaseManager {
    ...
    static async callFunction(functionName, payload = {}, useServiceRole = false) {
        try {
...
export class SessionManager {
    static client = SupabaseManager.getServiceClient();
    static async storeSession(sessionId, sessionData) {
        try {
...
export class VehicleDataManager {
    static client = SupabaseManager.getServiceClient();
    static async storeVehicleData(vin, vehicleData) {
        try {
            const { data, error } = await this.client
                .from('vehicle_data')
                .insert({
    ...
    static async getVehicleData(vin) {
        try {
            const { data, error } = await this.client
                .from('vehicle_data')
                .select('data')
