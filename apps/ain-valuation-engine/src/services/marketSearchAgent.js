...
const SUPABASE_URL = import.meta.env?.VITE_SUPABASE_URL || process.env.VITE_SUPABASE_URL || 'https://xltxqqzattxogxtqrggt.supabase.co';
...
export async function fetchMarketListings(input) {
    const diagnostics = { input, stages: [] };
