        ...
        try {
            ...
            if (fuelEconomy) {
                ...
                if (fuelEconomy.combinedMpg && avgFuelPricePerGallon !== null) {
                    ...
                    logger.warn(`Could not calculate annual fuel cost: Combined MPG missing for ${inputs.make} ${inputs.model}`);
                }
                else {
                    logger.warn('Could not calculate annual fuel cost: Average fuel price missing.');
                }
            }
        }
        catch (error) {
