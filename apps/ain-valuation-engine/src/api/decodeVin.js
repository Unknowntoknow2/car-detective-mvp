 ...
 * @deprecated Use decodeVin from unifiedVinDecoder.js directly instead
 */

import { decodeVin as unifiedDecodeVin, extractLegacyVehicleInfo, isVinDecodeSuccessful } from '../services/unifiedVinDecoder.js';
...
export async function decodeVin(vin) {
    console.warn('⚠️ src/api/decodeVin.js is DEPRECATED. Use unifiedVinDecoder.decodeVin directly.');
