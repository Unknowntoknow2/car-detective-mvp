...
BEGIN
  ...
  -- Also create user_roles entry if user_roles table exists
  INSERT INTO public.user_roles (user_id, role)
  VALUES (
    NEW.id,
    CASE 
      WHEN NEW.raw_user_meta_data->>'role' = 'dealer' THEN 'dealer'::public.user_role
...
SELECT 
  au.id,
  CASE 
    WHEN au.raw_user_meta_data->>'role' = 'dealer' THEN 'dealer'::public.user_role
    ELSE 'user'::public.user_role
  END
FROM auth.users au
