...
-- Create unique constraint separately for market_context_data
CREATE UNIQUE INDEX IF NOT EXISTS idx_market_context_unique 
ON public.market_context_data(make, model, year, COALESCE(trim, ''), zip_code);
